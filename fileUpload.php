...
if (isset($_FILES['upload'])){
    ...
    if(empty($error)){
        ...
        move_uploaded_file($_FILES['upload']['tmp_name'], "uploaded_files/{$_FILES['upload']['name']}");     
    }
    ...
    <head>
        <title>Security - Upload</title>
           ...
           <body>
               <div>
                   ...
                   if (isset($error)){
                       if (empty($error)){
                           ...
                           echo '<a href="uploaded_files/' . $_FILES['upload']['name'] . '">Check file';
               ...
               <a href="home.php"><i>Return to homepage</i></a>
           </body>
